     ...
     static void Main(string[] args)
        {
            ...
            player1Name = Console.ReadLine();
             ...
             if ( !Regex.Match(player1Name,"^[a-zA-Z0-9-]{1,15}$" ).Success )
             {
                 Console.WriteLine( "Your Name must be lese than 15 characters");
            ...
            while (true)
            {
                ...
                while (isTie)
                {
                    ...
                    Console.WriteLine($"{player1Name} Chose: { player1ChoiceStr}");
                    Console.WriteLine($"Player2 Chose: {computerChoice}");
                                    ...
                                    (player1Choice == 3 && computerChoice == 2))
                    {
                        ...
                        // update the tally for this gaming session of how many games the computer and the user have won.
                         player1wins++;// this method gives you the option of incrementing by more than 1
                                                      // player1wins += 1;
                                                      // player1wins++;
                        isTie = false;
                        ++score;
                    ...
                    {// if the computer won
                        ...
                        // update the tally for this gaming session of how many games the computer and the user have won.
                       computerWins++;// this method gives you the option of incrementing by more than 1.
                        isTie = false;
                ...
                Console.WriteLine($"Hey {player1Name} your score is {score}");
